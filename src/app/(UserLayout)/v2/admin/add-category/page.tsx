...
export default function CategoryForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold text-center mb-6">Create New Category</h2>
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="w-full mt-2 px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
        />
        {errors.coverImage?.message && <p className="text-red-500 text-sm mt-1">{errors.coverImage?.message as string}</p>}
      </div>
