...
const AnantyaLogo: React.FC<AnantyaLogoProps> = ({
  className = "",
  logoSize = "xlarge",
}) => {
      ...
      <header className="w-full py-4 px-6 bg-black text-white">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6">
            ...
            <a href="/services" className="text-yellow-400 font-medium">
              Services
            </a>
          </nav>
        ...
        <section className="py-20 bg-black text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              We Provide Product Sourcing
            </h2>
            <p className="text-lg max-w-2xl mx-auto mb-8 text-gray-300">
              We sell products to wholesalers, connect with manufacturers, and
              handle all aspects of freight forward.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-10">
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow overflow-hidden group">
                ...
                <CardContent className="pt-6 p-8">
                  ...
                  <p className="text-gray-600 text-center">
                    We identify and acquire high-quality products from trusted
                    global sources tailored to your business needs and market
                    demands.
                  </p>
                  <div className="mt-6 text-center">
                    <Button
                      variant="ghost"
                      className="text-black hover:text-red-600 p-0 group-hover:translate-x-2 transition-transform"
                    >
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow overflow-hidden group">
                ...
                <CardContent className="pt-6 p-8">
                  ...
                  <p className="text-gray-600 text-center">
                    We establish and nurture direct relationships with
                    manufacturers to ensure quality, competitive pricing, and
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow overflow-hidden group">
                ...
                <CardContent className="pt-6 p-8">
                  ...
                  <p className="text-gray-600 text-center">
                    We manage the entire logistics process including shipping,
                    customs clearance, documentation, and final delivery to your
                    specified location.
                  </p>
                  <div className="mt-6 text-center">
                    <Button
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
                ...
                <p className="text-lg text-gray-700 mb-6">
                  With strategic partnerships across Asia, Europe, North
                  America, and beyond, we connect you to a world of
                  opportunities for sourcing premium products.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  Our extensive network enables us to navigate international
                  markets with ease, identifying the best suppliers and
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center p-6">
                ...
                <p className="text-gray-400">
                  Rigorous quality control at every stage ensures only the best
                  products reach you.
                </p>
              </div>
              <div className="text-center p-6">
                ...
                <p className="text-gray-400">
                  Efficient processes and established relationships ensure
                  timely delivery.
                </p>
              </div>
              <div className="text-center p-6">
                ...
                <p className="text-gray-400">
                  Direct manufacturer relationships allow us to secure the best
                  possible prices.
                </p>
              </div>
              <div className="text-center p-6">
                ...
                <p className="text-gray-400">
                  Our experienced team provides personalized guidance throughout
                  the entire process.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Your trusted partner for global product sourcing and logistics.
                Connecting businesses with quality manufacturers worldwide since
                2015.
              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} Anantya Overseas. All rights
              reserved.
            </p>
          </div>
        </div>
